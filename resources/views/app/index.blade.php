                            ...
                            <div class="item">
                                <a href="{{ route('app.advertises.show', $advertise->id) }}">
                                    <div class="properties">
                                        <a href="{{ route('app.advertises.show', $advertise->id) }}" class="img d-flex justify-content-center align-items-center"
                ...
                <div class="properties-slider owl-carousel ftco-animate">
                    @foreach ($bestAdvertises as $advertise)
                        <div class="col-sm col-md-6 col-lg ftco-animate">
                            <div class="properties">
                                <a href="{{ route('app.advertises.show', $advertise->advertise->id) }}"
                                    class="img img-2 d-flex justify-content-center align-items-center"
                                    style="background-image: url({{ asset($advertise->advertise->image) }});">
                                    <div class="icon d-flex justify-content-center align-items-center">
                                        <span class="icon-search2"></span>
                                    </div>
                                </a>
                                <div class="p-3 text">
                                    @if ($advertise->advertise->sell_status === 'خرید')
                                        <span class="status sale">خرید</span>
                                    @else
                                        <span class="status rent">اجاره</span>
                                    @endif
                                    <div class="">
                                        <div class="">
                                            <h3>...{{ Str::substr($advertise->advertise->address, 0, 20) }}</h3>
                                            <p>{{ $advertise->home_type }}</p>
                                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-4 d-flex justify-content-center counter-wrap ftco-animate">
                            <div class="text-center block-18">
                                <div class="text">
                                    <strong class="number"
                                        data-number="{{ $interstingFacts['advertise_count'] }}">
                    ...
                    <div class="d-flex ftco-animate">
                        <div class="blog-entry align-self-stretch">
                            ...
                            <div class="mt-3 text d-block">
                                <h3 class="mt-3 heading" style="min-height: 6rem">
                                    <a
                                        href="{{ route('app.posts.show', $post->slug) }}" style="font-family: Vazir !important">{{ $post->title }}</a>
                                </h3>
                                <div class="mb-3 meta">
