                    ...
                    <div class="card-content">
                        <div class="card-body card-dashboard">
                            ...
                            <form class="row d-flex flex-column"
                                action="{{ route('dashboard.users.permissions.updateUserPermissions', $user->id) }}" method="post">
                                @csrf
                                @method('put')
                                ...
                                <section class="mb-2 border-bottom-primary">
                                    ...
                                    <section>
                                        <div>
                                            <input type="checkbox" id="category_force_delete" value="category_force_delete"
                                                name="permissions[category_force_delete]"
                                ...
                                <section class="mb-2 border-bottom-primary">
                                    ...
                                    <section>
                                        <div>
                                            <input type="checkbox" id="advertise_access_all" value="advertise_access_all"
                                                name="permissions[advertise_access_all]"
                                    ...
                                    <section>
                                        <div>
                                            <input type="checkbox" id="advertise_force_delete"
                                                value="advertise_force_delete" name="permissions[advertise_force_delete]"
